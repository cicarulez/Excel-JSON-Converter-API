...
const models: TsoaRoute.Models = {
    ...
    "ExcelData": {
        ...
        "additionalProperties": {"dataType":"array","array":{"dataType":"refObject","ref":"ExcelDataColValue"}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    "ServerInfo": {
        "dataType": "refObject",
        "properties": {
            "totalMemory": {"dataType":"string","required":true},
            "freeMemory": {"dataType":"string","required":true},
            "uptime": {"dataType":"string","required":true},
            ...
            "loadAverage": {"dataType":"string","required":true},
            "cpus": {"dataType":"string","required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "GenericResponse_ServerInfo_": {
        "dataType": "refObject",
        "properties": {
            "data": {"ref":"ServerInfo","required":true},
            "message": {"dataType":"string"},
        },
        "additionalProperties": false,
    },
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.post('/api/files/convertExcelToJson',
            upload.single('file'),
            ...(fetchMiddlewares<RequestHandler>(FilesController)),
            ...(fetchMiddlewares<RequestHandler>(FilesController.prototype.convertExcelToJson)),

            function FilesController_convertExcelToJson(request: any, response: any, next: any) {
            const args = {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/api/status/serverInfo',
            ...(fetchMiddlewares<RequestHandler>(StatusController)),
            ...(fetchMiddlewares<RequestHandler>(StatusController.prototype.serverInfo)),

            function StatusController_serverInfo(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.serverInfo.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
